...
export const siteConfig: SiteConfig = {
  ...
  meta: {
    ...
    defaultDescription: 'Strategy & Operations Manager specializing in business development, international trade, and real estate investment',
    keywords: ['strategy', 'operations', 'business development', 'B2B sales', 'real estate investment', 'international trade', 'Vilnius'],
    siteUrl: 'https://usaris.lt',
    locale: 'en',
  },
  ...
  navigation: {
    items: [
      ...
      { label: 'Skills', href: '#skills', icon: 'Target', enabled: true },
      { label: 'Education', href: '#education', icon: 'GraduationCap', enabled: true },
      { label: 'Ventures', href: '/portfolio', icon: 'TrendingUp', enabled: true },
